...
fun Alert(
    ...
    Dialog(visible = visible) {
        Row(
            ...
            Column {
                ProvideTextStyle(Theme[textStyles][com.example.rxtracker.uikit.styling.title]) {
                    title()
                }
                Spacer(Modifier.height(16.dp))
                ProvideTextStyle(Theme[textStyles][com.example.rxtracker.uikit.styling.body]) {
                    body()
                }
...
fun CenteredAlert(
    ...
    Dialog(visible = visible) {
        Column(Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            ProvideTextStyle(
                Theme[textStyles][com.example.rxtracker.uikit.styling.title]
